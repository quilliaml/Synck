						...
						<div id="displayUsers" style="">
							<?php 
								...
								foreach ($data as $row) {
									...
									echo "<td>" . $row["RH"] . "</td>";
									echo "<td>" . $row["NetworkTeam"] . "</td>"; 
									echo "<td>" . $row["Accounting"] . "</td>"; 
									echo "<td>" . $row["Developers"] . "</td>"; 
							...
							?>
									...
									<dialog id="mydialog<?php echo $id?>" class="mydialog" draggable=true close>					
										<form method="post" action="modifGroup.php">
											...
											<input type="checkbox" id="<?php echo $a?>" name="group0" checked/>
											<label for="<?php echo $a?>">RH</label>
											
											<?php
												}else{
											?>
											
											<input type="checkbox" id="<?php echo $a?>" name="group0"/>
											<label for="<?php echo $a?>">RH</label>
											...
											<input type="checkbox" id="<?php echo $b;?>" name="group1" checked/>
											<label for="<?php echo $b;?>">Network Team</label>
											
											<?php
												}else{
											?>
											
											<input type="checkbox" id="<?php echo $b;?>" name="group1"/>
											<label for="<?php echo $b;?>">Network Team</label>
											...
											<input type="checkbox" id="<?php echo $c;?>" name="group2" checked/> 
											<label for="<?php echo $c;?>">Accounting</label>
											
											<?php
												}else{
											?>
											
											<input type="checkbox" id="<?php echo $c;?>" name="group2" /> 
											<label for="<?php echo $c;?>">Accounting</label>
											...
											<input type="checkbox" id="<?php echo $d;?>" name="group3" checked/>
											<label for="<?php echo $d;?>">Developers</label>
											
											<?php
												}else{
											?>
											
											<input type="checkbox" id="<?php echo $d;?>" name="group3" />
											<label for="<?php echo $d;?>">Developers</label>
											...
											<input type="checkbox" id="<?php echo $e;?>" name="group4" checked/>
											<label for="<?php echo $e;?>">Project</label>
										
											<?php
												}else{
											?>
											
											<input type="checkbox" id="<?php echo $e;?>" name="group4" />
											<label for="<?php echo $e;?>">Project</label>
