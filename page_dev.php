		...
		<div id="page-wrapper">
			...
			<section class="panel color1">
			  ...
			  <div class="search-container">
				<form method = "get" action="search_dev.php" style="display:flex;">
						...
						<?php 
							...
							*/
							...
							$cfgbdd = require('config.php');
								...
								$limit = 3;
								$debut = ($page - 1) * $limit;
								$resultFoundRows = $db->query('SELECT count(f_id) FROM files where Developers=1');
								$nombredElementsTotal = $resultFoundRows->fetchColumn();
								$debut = ($page - 1) * $limit;
								$nombreDePages = ceil($nombredElementsTotal / $limit);							
								
								$query = "select * from files where Developers=1 ORDER BY f_type LIMIT :limit OFFSET :debut";
							...
							<div id ="upload" style="margin-left:60%;">
								<form method="post" action="fileUpload.php" enctype="multipart/form-data">
									<div class="upload-button-wrapper">
										...
										<input name="file_type" type="hidden" value="Developers">
