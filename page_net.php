			...
			<div id="wrapper">
				<section class="panel banner">
					<div class="content color0 span-3-75" id="first">
						<h1> Espace Network Team</h1> 
						
						<p> 
							Vous vous êtes connecté sur votre espace NetworkTeam<br>
						</p>
			  ...
			  <div class="search-container">
				<form method = "get" action="search_net.php" style="display:flex;">
				  ...
				  <button type="submit"><i class="fa fa-search"></i></button>
						...
						<?php 
							...
							*/
							...
							if (!$thelist = glob('groups/NetworkTeam/*', GLOB_NOSORT)) {
							...
							$cfgbdd = require('config.php');
								...
								$limit = 3;
								$debut = ($page - 1) * $limit;
								$resultFoundRows = $db->query('SELECT count(f_id) FROM files where NetworkTeam=1');
								$nombredElementsTotal = $resultFoundRows->fetchColumn();
								$debut = ($page - 1) * $limit;
								$nombreDePages = ceil($nombredElementsTotal / $limit);							
								
								$query = "select * from files where NetworkTeam=1 ORDER BY f_type LIMIT :limit OFFSET :debut";
							...
							<div id ="upload" style="margin-left:60%;">
								<form method="post" action="fileUpload.php" enctype="multipart/form-data">
									<div class="upload-button-wrapper">
										...
										<input name="file_type" type="hidden" value="NetworkTeam">
